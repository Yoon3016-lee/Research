        ...
        {homepage.logoUrl ? (
          <>
            ...
            <img
              ...
              className="h-8 w-auto max-w-none origin-left object-contain object-left sm:h-9 [transform:scaleX(1.2)]"
            />
          </>
        ) : (
          <span className="site-name-font origin-left text-lg font-semibold tracking-tight text-brand-900 sm:text-xl [transform:scaleX(1.2)]">
            {homepage.siteName}
          </span>
        )}
      </Link>
