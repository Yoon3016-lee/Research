...
import { PromptRichTextEditor } from "@/components/admin/survey-builder/PromptRichTextEditor";
                              ...
                              >
                                {priorBranching.map(({ pq, pi }) => (
                                  <option key={pi} value={pi}>
                                    문항 {pi + 1}
                                    {stripSurveyPromptHtml(pq.prompt)
                                      ? ` — ${stripSurveyPromptHtml(pq.prompt).slice(0, 40)}`
                                      : ""}
                                  </option>
                                ))}
                              </select>
