    ...
    <aside className="admin-sidebar">
      ...
      <nav className="flex flex-1 flex-col gap-0.5 p-2.5" aria-label="관리자 메뉴">
        ...
        {role === "super_admin" ? (
          <Link
            href="/admin/nav"
            className={navLinkClass(pathname.startsWith("/admin/nav"))}
          >
        ...
        {role === "super_admin" ? (
          <Link
            href="/admin/homepage"
            className={navLinkClass(pathname.startsWith("/admin/homepage"))}
          >
        ...
        {role === "super_admin" ? (
          <Link
            href="/admin/banners"
            className={navLinkClass(pathname.startsWith("/admin/banners"))}
          >
        ...
        {role === "super_admin" ? (
          <Link
            href="/admin/settings"
            className={navLinkClass(pathname.startsWith("/admin/settings"))}
          >
